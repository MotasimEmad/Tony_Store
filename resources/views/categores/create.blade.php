              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/categores/store" enctype="multipart/form-data" method='POST'>
                    @csrf
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="descrption" name="descrption" rows="4"></textarea>
                      </div>
